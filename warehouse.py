...
# Tao bang dim_payment theo dung checklist cua nhom
print("Dang tao dim_payment...")
dim_payment = df[['order_id', 'payment_sequential', 'payment_type', 'payment_installments', 'payment_value']].drop_duplicates()
